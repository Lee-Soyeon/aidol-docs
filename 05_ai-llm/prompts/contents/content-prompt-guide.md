...
| Gaze       | 5    | 아래, 옆 흘깃, 카메라 밖, 시선 회피, 눈맞춤              |
| Expression | 5    | 부드러운 미소, 웃참, 수줍은 미소, 또렷한 눈빛, 은은한 웃음 |
| Outfit     | 4    | 카디건+교복셔츠, 블레이저+교복셔츠, 카디건+캐주얼티, 블레이저+캐주얼티 |
| Camera     | 6    | 정면 클로즈업, 사선 클로즈업, 가슴 위, 상반신 미디엄, 하이앵글, 측면 미디엄 |
| Atmosphere | 4    | 스티커, 형광등 졸린분위기, 골든아워, 흐린 날             |
  ...
  "combinations": [
    {
      ...
      "camera": "front_closeup",
      "atmosphere": "idol_casual_snapshot"
    }
  ]
}
```

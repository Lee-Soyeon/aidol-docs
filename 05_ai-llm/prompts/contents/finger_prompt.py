...
SCENE_OPTIONS = {
    "practice_room": "K-pop practice room with wooden floor. Speakers or studio equipment visible in the background; slightly messy training environment. The mirror wall is off to the side, outside the camera frame or barely visible at the edge. The subject is standing upright with both feet on the floor, weight evenly distributed, shoulders level and relaxed — not leaning, sitting, crouching, or tilting to either side. The right hand is raised near the cheek making a Korean finger heart (thumb tip and index finger tip touching). The left hand is tucked inside a pocket and not visible, while the left arm remains naturally positioned by the side. No hand is touching the face. Casual and a little shy, not exaggerated, as if someone snapped a quick photo during a break.",
}
